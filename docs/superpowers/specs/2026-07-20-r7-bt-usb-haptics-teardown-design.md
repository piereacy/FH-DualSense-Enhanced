...
日期：2026-07-20
状态：实机验证失败，已由 `2026-07-20-r7-bt-usb-audio-readiness-design.md` 取代

> 实机候选确认 `0x08 / 0x02` 返回成功并完成 BT -> USB HID handover，但 USB 握把触觉仍然消失。该命令单独使用不能解决问题，本文件仅保留为已验证失败方案的历史记录。
