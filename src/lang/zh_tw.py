...
STRINGS.update({
    ...
    "Automatic detection failed. Rescan or choose the Xbox App FH6 install folder.": "自動偵測失敗。請重新掃描或選擇 Xbox App 版 FH6 安裝資料夾。",
...
STRINGS.update({
    ...
    "Windows Steam and Xbox App editions. Install folders are detected automatically; manual selection remains available.": "支援 Windows Steam 與 Xbox App 版本。安裝資料夾會自動偵測，也可以繼續手動選擇。",
