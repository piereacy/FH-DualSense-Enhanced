...
STRINGS.update({
    ...
    "Automatic detection failed. Rescan or choose the Xbox App FH6 install folder.": "Die automatische Erkennung ist fehlgeschlagen. Erneut suchen oder den Installationsordner der Xbox-App-Version von FH6 auswählen.",
    ...
    "Windows Steam and Xbox App editions. Install folders are detected automatically; manual selection remains available.": "Windows-Versionen für Steam und Xbox App. Installationsordner werden automatisch erkannt; die manuelle Auswahl bleibt verfügbar.",
