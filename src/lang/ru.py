...
STRINGS.update({
    ...
    "Automatic detection failed. Rescan or choose the Xbox App FH6 install folder.": "Автоматическое обнаружение не удалось. Повторите поиск или выберите папку установки FH6 из Xbox App.",
    ...
    "Windows Steam and Xbox App editions. Install folders are detected automatically; manual selection remains available.": "Версии Windows для Steam и Xbox App. Папки установки определяются автоматически; ручной выбор также доступен.",
