...
STRINGS.update({
    "Finding FH6...": "正在尋找 FH6...",
    "Launch FH6": "啟動 FH6",
    "Starting FH6...": "正在啟動 FH6...",
    "FH6 is running": "FH6 執行中",
    "FH6 not found": "找不到 FH6",
    "Could not launch FH6: {error}": "無法啟動 FH6：{error}",
    "Sent FH6 launch request to Steam": "已向 Steam 傳送 FH6 啟動請求",
})
