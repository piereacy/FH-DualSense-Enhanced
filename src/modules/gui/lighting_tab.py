"""Optional controller lighting, isolated from trigger and haptic tuning."""
...
class LightingTab(SettingsTab):
    ...
    PAGE_TITLE = "Controller lighting"
    PAGE_SUBTITLE = "Optional visual feedback with independent switches."
