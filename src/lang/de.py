...
STRINGS.update({
    "Finding FH6...": "FH6 wird gesucht...",
    "Launch FH6": "FH6 starten",
    "Starting FH6...": "FH6 wird gestartet...",
    "FH6 is running": "FH6 läuft",
    "FH6 not found": "FH6 nicht gefunden",
    "Could not launch FH6: {error}": "FH6 konnte nicht gestartet werden: {error}",
    "Sent FH6 launch request to Steam": "FH6-Startanfrage an Steam gesendet",
})
