...
STRINGS.update({
    ...
    "Automatic detection failed. Rescan or choose the Xbox App FH6 install folder.": "Otomatik algılama başarısız oldu. Yeniden tarayın veya Xbox App FH6 kurulum klasörünü seçin.",
    ...
    "Windows Steam and Xbox App editions. Install folders are detected automatically; manual selection remains available.": "Windows Steam ve Xbox App sürümleri. Kurulum klasörleri otomatik algılanır; elle seçim de kullanılabilir.",
