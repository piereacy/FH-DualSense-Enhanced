...
STRINGS.update({
    ...
    "Choose the Xbox App FH6 install folder to continue.": "続行するには Xbox App 版 FH6 のインストール先を選択してください。",
...
STRINGS.update({
    ...
    "Windows Steam and Xbox App editions. Steam paths are detected automatically; choose the Xbox App install folder manually.": "Windows の Steam 版と Xbox App 版に対応します。Steam のパスは自動検出し、Xbox App 版はインストール先を手動で選択します。",
